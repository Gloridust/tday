(function() {
    function l() {
        ...
        this.M = "";
        this.o = "1397896561";
        this.P = "hzs10.cnzz.com";
        this.L = "";
        this.s = "CNZZDATA" + this.c;
        this.r = "_CNZZDbridge_" + this.c;
        this.G = "_cnzz_CV" + this.c;
        this.u = "0";
        this.B = {};
        this.a = {};
        this.la()
    ...
    l.prototype = {
            ...
            try {
                ...
                if ("[object Array]" === {}.toString.call(a))
                    for (var b = 0; b < a.length; b++) {
                        ...
                        switch (c[0]) {
                            case "_setAccount":
                                f._cz_account = "[object String]" === {}.toString.call(c[1]) ? c[1] : String(c[1]);
                                break;
                            case "_setAutoPageview":
                                "boolean" === typeof c[1] && (f._cz_autoPageview = c[1])
                        }
                    }
        ...
        C: function(a) {
            try {
                if ("[object Array]" === {}.toString.call(a)) switch (a[0]) {
                    ...
                    case "_trackEvent":
                        var c = [];
                        a[1] && a[2] && (c.push(d(a[1])), c.push(d(a[2])), c.push(a[3] ? d(a[3]) : ""), a[4] = parseFloat(a[4]), c.push(isNaN(a[4]) ? 0 : a[4]), c.push(a[5] ? d(a[5]) :
        ...
        ca: function() { try { if ("" !== f.location.hash) return this.F = f.location.href } catch (a) { g(a, "gCP failed") } },
        j: function() { try { return this.a.ra = h.referrer || "" } catch (a) { g(a, "gR failed") } },
        ea: function() { try { return this.a.n = f.navigator.systemLanguage || f.navigator.language, this.a.n = this.a.n.toLowerCase(), this.a.n } catch (a) { g(a, "gL failed") } },
        ha: function() { try { return this.a.Q = f.screen.width && f.screen.height ? f.screen.width + "x" + f.screen.height : "0x0", this.a.Q } catch (a) { g(a, "gS failed") } },
        ...
        fa: function() { try { return this.a.e = this.h("rtime"), null === this.a.e && (this.a.e = 0), 0 < this.I() && 432E5 < (new Date).getTime() - this.I() && (this.a.e++, this.a.q = (new Date).getTime()), this.a.e } catch (a) { g(a, "gRVT failed") } },
        ja: function() { try { return "none" === this.m() ? this.a.S = 0 : this.a.S = parseInt(((new Date).getTime() - 1E3 * this.m()) / 1E3) } catch (a) { g(a, "gST failed") } },
        ia: function() {
            try {
                var a = this.h("sin") || "none";
                if (!h.domain) return this.a.p = "none";
                ...
                if (1E8 < this.c) {
                    if ("none" !== this.a.i) b.push(d(this.a.i));
                        ...
                        var e = Math.floor(2147483648 *
                            Math.random()) + "-" + this.o + "-" + this.D(this.j());
                        b.push(d(e))
                    }
                    b.push(this.o);
                    ...
                    b.push("rtime=" + d(this.a.e)), 0 < b.length ? (a += d(b.join("&")), a += "; expires=" + c.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString();
                h.cookie = a
            } catch (f) { g(f, "sS failed") }
        },
        h: function(a) { try { return "undefined" !== typeof this.B[a] ? this.B[a] : null } catch (b) { g(b, "gCPa failed") } },
        Y: function(a, b) {
            try {
                if (b = b || "utf-8", "1" === this.u) {
                    ...
                    e.parentNode && e.parentNode.insertBefore(c,
                        e)
        ...
        Z: function(a) {
            try {
                ...
                d ? d.innerHTML = c : "0" === this.u && h.write(c)
        ...
        A: function() {
            try {
                ...
                var a = [];
                a.push("id=" + d(this.c));
                this.a.f || "" === this.a.f ? a.push("r=" + d(this.a.f)) : a.push("r=" + d(this.a.ra));
                a.push("lg=" + d(this.a.n));
                a.push("ntime=" + d(this.a.na));
                a.push("repeatip=" + this.a.v);
                a.push("rtime=" + d(this.a.e));
                a.push("cnzz_eid=" + d(this.a.i));
                a.push("showp=" + d(this.a.Q));
                a.push("st=" + d(this.a.S));
                a.push("sin=" +
                    d(this.a.p));
                this.a.d ? a.push("p=" + d(this.a.d)) : "[object String]" === {}.toString.call(this.F) && a.push("p=" + d(this.F));
                "[object String]" === {}.toString.call(this.l) && a.push("ei=" + d(this.l));
                "[object String]" === {}.toString.call(this.b) && a.push("cv=" + this.b);
                a.push("t=" + d(this.a.pa));
                var b = a.join("&");
                "[object String]" === {}.toString.call(this.l) ? this.k([m + "//ei.cnzz.com/stat.htm?" + b]) : (this.L && this.k([m + "//" + this.L + "/stat.htm?" + b]), this.P && this.k([m + "//" + this.P + "/stat.htm?" + b]))
            } catch (c) { g(c, "sD failed") }
        },
        ma: function(a) { return 0 > r(a).indexOf("%u") ? !1 : !0 },
        k: function(a) { try { for (var b = a.length, c = null, d = 0; d < b; d++) a[d] && (c = "cnzz_image_" + Math.floor(2147483648 * Math.random()), f[c] = new Image, f[c].W = c, f[c].onload = f[c].onerror = f[c].onabort = function() { try { this.onload = this.onerror = this.onabort = null, f[this.W] = null } catch (a) {} }, f[c].src = a[d] + "&rnd=" + Math.floor(2147483648 * Math.random())) } catch (h) { g(h, "cR failed") } }
    };
    try {
        var n = new l;
        f[n.r].bobject = n;
        !1 !== f._cz_autoPageview ? n.A() : n.O();
        l.prototype.getACookie = l.prototype.t;
        l.prototype.callRequest = l.prototype.k;
        l.prototype.createScriptIcon = l.prototype.$;
        l.prototype.createIcon = l.prototype.Z;
        n.sa()
